...
export const fr: Translations = {
  ...
  checkWarning: (missingDays) => `Abacus: ${missingDays} non enregistré`,
  checkReminder: "Avez-vous enregistré vos heures ? Vérifiez avec : abacus summary",
  timeAgoMinutes: (n) => `${n}min`,
  timeAgoHours: (n) => `${n}h`,
  timeAgoDays: (n) => `${n}j`,
  updatingCache: "Mise à jour du cache de statut...",
  defaultBookingText: "Développement",
};
