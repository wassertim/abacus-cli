...
export const es: Translations = {
  ...
  checkWarning: (missingDays) => `Abacus: ${missingDays} no registrado`,
  checkReminder: "¿Registraste tus horas? Verifica con: abacus summary",
  timeAgoMinutes: (n) => `${n}min`,
  timeAgoHours: (n) => `${n}h`,
  timeAgoDays: (n) => `${n}d`,
  updatingCache: "Actualizando caché de estado...",
  defaultBookingText: "Desarrollo",
};
